...
const SYS_SERVICE_PROTO = ['wrappers_grpc_pb.d.ts', 'manager_grpc_pb.d.ts'];
...
export async function start(host: string): Promise<void> {
    ...
    //     setNetwork(call: grpc.ServerUnaryCall<ZDRequest, ZDResponse>, callback: grpc.sendUnaryData<ZDResponse>): void {
